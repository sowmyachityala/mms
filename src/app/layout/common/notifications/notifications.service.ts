...
export class NotificationsService
{
    ...
    {
        return this._httpClient.get<Notification[]>(this.baseUrl + environment.apiEndPoints.getUserNotifications).pipe(
            tap((notifications) => {
    ...
    getUserNotifications(){
        return this._httpClient.get(this.baseUrl + environment.apiEndPoints.getUserNotifications);
    }
    /**
