...
@Component({
    selector: 'app-donation-charges',
    templateUrl: './donation-charges.component.html',
    styleUrl: './donation-charges.component.scss',
})
export class DonationChargesComponent {
    ...
    constructor(
        public dialogRef: MatDialogRef<DonationChargesComponent>,
    ...
    confirmDonation() {
        const payload = {
            ...
            userEmail: this.mosqueEmail, // replacing user email in server side
