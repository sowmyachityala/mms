...
@Component({
    selector: 'app-mosqque-follower',
    templateUrl: './mosqque-follower.component.html',
    styleUrl: './mosqque-follower.component.scss',
})
export class MosqqueFollowerComponent {
    followerList = [];
    isLoading = true;
    searchKey: string;
    pageLength = 0;
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<MosqqueFollowerComponent>,
    ...
    GetFollowersList() {
        this.userService
            .getFollowersListForMosque(this.mosqueGuid)
            .subscribe((res: any) => {
                if (res?.result?.success) {
                    this.followerList = res?.result?.data;
