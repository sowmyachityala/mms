...
@Component({
    selector: 'app-daily-hadith',
    templateUrl: './daily-hadith.component.html',
    styleUrl: './daily-hadith.component.scss',
})
export class DailyHadithComponent {
    ...
    GetHadithTopics() {
        this.sharedService.getHaditTopics().subscribe((res: any) => {
    ...
    selectedTopic(topicId) {
        ...
        this.sharedService
            ...
            .subscribe((res: any) => {
                if (res?.result?.success) {
                    this.TopicDetailData = res?.result?.data;
                }
            });
    }
