...
@Component({
    selector: 'app-insp-geetings',
    templateUrl: './insp-geetings.component.html',
    styleUrl: './insp-geetings.component.scss',
})
export class InspGeetingsComponent {
    @ViewChild('iconScroll', { static: true }) iconScroll!: ElementRef;
    @ViewChildren('iconItem') iconItemElements!: QueryList<ElementRef>;
    constructor(private router: Router) {}
    activeIndex: number = 11;
    menuItems = [
        {
